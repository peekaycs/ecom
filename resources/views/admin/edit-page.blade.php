...
<div class="col-md-12">
    <div class="card">
    <form class="form-horizontal" id="" method="post" action="{{route('update-page',$page->id)}}">
        ...
        <div class="card-body">
            ...
            <div class="form-group form-floating-label @error('name') has-error @enderror">
                <input id="" name="name" value="{{old('name') ?? $page->name}}" type="text" class="form-control input-border-bottom " required>
            ...
            <div class="form-group form-floating-label @error('slug') has-error @enderror">
                <input id="" name="slug" value="{{old('slug') ?? $page->slug}}" type="text" class="form-control input-border-bottom" required>
            ...
            <div class="form-group form-floating-label @error('title') has-error @enderror">
                <input id="" name="title" value="{{old('title') ?? $page->title}}" type="text"  class="form-control input-border-bottom" required>
            ...
            <div class="form-group form-floating-label @error('meta_keywords') has-error @enderror">
                <input id="" name="meta_keywords" value="{{old('meta_keywords') ?? $page->meta_keywords}}" type="text"  class="form-control input-border-bottom" >
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12 col-md-12">
                    <div class="form-group form-floating-label @error('content') has-error @enderror">
                        <textarea name="content"  id="content" class="form-control input-border-bottom @error('name')  @enderror" >{{old('content') ?? $page->content}}</textarea>
                    </div>
                    @error('content')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
            ...
            <div class="form-group form-floating-label @error('published') has-error @enderror">
                <select class="form-control input-border-bottom" name="published" id="published" required>
                    <option value=""></option>
                    <option value="1" @if($page->getOriginal('published') == 1) {{'selected'}} @endif >Publish</option>
                    <option value="0" @if($page->getOriginal('published') == 0) {{'selected'}} @endif >Unpublish</option>
                </select>
