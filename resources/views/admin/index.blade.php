								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="{{URL::asset('assets/admin/img/jm_denis.jpg')}}" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{URL::asset('assets/admin/img/chadengle.jpg')}}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{URL::asset('assets/admin/img/mlane.jpg')}}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{URL::asset('assets/admin/img/talha.jpg')}}" alt="Img Profile">
												</div>
												<div class="notif-content">
								...
								<li>
									<div class="notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{URL::asset('assets/admin/img/profile2.jpg')}}" alt="Img Profile">
												</div>
												<div class="notif-content">
													<span class="block">
												...
												<table class="table">
													<tbody>
														<tr>
															<td>
																<div class="flag">
																	<img src="{{URL::asset('assets/admin/img/flags/id.png')}}" alt="indonesia">
																</div>
															</td>
															<td>Indonesia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{URL::asset('assets/admin/img/flags/us.png')}}" alt="united states">
																</div>
															</td>
															<td>USA</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{URL::asset('assets/admin/img/flags/au.png')}}" alt="australia">
																</div>
															</td>
															<td>Australia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{URL::asset('assets/admin/img/flags/ru.png')}}" alt="russia">
																</div>
															</td>
															<td>Russia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{URL::asset('assets/admin/img/flags/cn.png')}}" alt="china">
																</div>
															</td>
															<td>China</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{URL::asset('assets/admin/img/flags/br.png')}}" alt="brazil">
																</div>
															</td>
															<td>Brasil</td>
															<td class="text-right">
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body pb-0">
									<div class="d-flex">
										<div class="avatar">
											<img src="{{URL::asset('assets/admin/img/logoproduct.svg')}}" alt="..." class="avatar-img rounded-circle">
										</div>
									...
									<div class="d-flex">
										<div class="avatar">
											<img src="{{URL::asset('assets/admin/img/logoproduct3.svg')}}" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										<div class="item-list">
											<div class="avatar">
												<img src="{{URL::asset('assets/admin/img/jm_denis.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{URL::asset('assets/admin/img/chadengle.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{URL::asset('assets/admin/img/talha.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{URL::asset('assets/admin/img/mlane.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
