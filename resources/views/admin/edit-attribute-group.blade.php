...
<div class="col-md-12">
    <div class="card">
    <form class="form-horizontal" id="" method="post" action="{{route('update-attribute-group',$attributeGroup->id)}}">
        ...
        <div class="card-body">
            ...
            <div class="form-group form-floating-label has-error">
                <input id="" name="name" value="{{old('name') ? old('name') : ($attributeGroup->name ?? '')}}" type="text" class="form-control input-border-bottom @error('name')  @enderror" required>
