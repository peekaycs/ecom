@extends('admin.layouts.app',['page_title' => 'Vendors','action_title' => 'Vendors','page_action' => route('vendors')])

@section('content')

<div class="col-md-12">
    <div class="card">
    <form class="form-horizontal" id="" method="post" action="{{route('update-vendor-user',$user->id)}}">
